...
class SVMBoundary:
    ...
    def __init__(self, xdataset:xr.Dataset, num_boundary_points:int=100, boundary_threshold:float=0.02):
        ...
        self.boundary_points = self.svm_boundary_from_xarray()
        print('length of boundary points:', len(self.boundary_points))
